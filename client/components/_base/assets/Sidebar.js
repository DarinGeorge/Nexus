...
export default function SideNav({ user }) {
  ...
  const isActive = value => (router.pathname === value ? classes.active : '');
  ...
  return (
    <>
      ...
      >
        ...
        <List>
          <ListItem button>
            <ListItemIcon color='inherit' aria-label='open drawer' edge='start'>
              <AppsSharpIcon
          ...
          <ListItem button>
            <ListItemIcon color='inherit' aria-label='open drawer' edge='start'>
              <NotificationsIcon
                className={clsx(classes.menuButton, isActive('/notifications'))}
              />
            </ListItemIcon>
